...
| F2  | Invalid plugin name is rejected           | `plugin.json` uses an invalid plugin name                                             | Delivery is blocked until the name is corrected to `medical-student-coach-plugin`                                               |
