...
Do not invent missing product, package, service, pipeline, or lifecycle
boundaries. Verify the repository surface before making claims.
...
Apply this envelope to every delegated or role-pass task:
